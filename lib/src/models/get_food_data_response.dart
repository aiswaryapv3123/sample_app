...
//
//     final foodDataResponse = foodDataResponseFromJson(jsonString);

import 'dart:convert';

List<FoodDataResponse> foodDataResponseFromJson(String str) => List<FoodDataResponse>.from(json.decode(str).map((x) => FoodDataResponse.fromJson(x)));

String foodDataResponseToJson(List<FoodDataResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class FoodDataResponse {
  FoodDataResponse({
    this.restaurantId,
    this.restaurantName,
  ...
  factory FoodDataResponse.fromJson(Map<String, dynamic> json) => FoodDataResponse(
...
class AddonCat {
  ...
  factory AddonCat.fromJson(Map<String, dynamic> json) => AddonCat(
    ...
    nexturl: json["nexturl"] == null ? null : json["nexturl"],
    addons: json["addons"] == null ? null : List<CategoryDish>.from(json["addons"].map((x) => CategoryDish.fromJson(x))),
  );
...
class CategoryDish {
  ...
  factory CategoryDish.fromJson(Map<String, dynamic> json) => CategoryDish(
    ...
    dishCurrency: json["dish_currency"] == null ? null : dishCurrencyValues.map[json["dish_currency"]],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "dish_currency": dishCurrency == null ? null : dishCurrencyValues.reverse[dishCurrency],
